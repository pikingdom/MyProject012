package com.nd.hilauncherdev.plugin.weather.loc;
...
public class LocationService {
	...
	private BaiduLocCallback callback;


	public void setCallback(BaiduLocCallback callback){
